...
const CropSeasonCalculator = () => {
  ...
  return (
    <main className="four">
      ...
      {cropData && (
        <div className="data">
          {(Object.keys(cropData).length > 10) ? (
            <div className="more_info">
              <div>
                <span className="data-item-title">ري عادي افراد:</span>
                <span className="data-item-value">{cropData.tr_ind_val}</span>
              </div>
              <div>
                <span className="data-item-title">ري حديث افراد:</span>
                <span className="data-item-value">{cropData.mod_ind_val}</span>
              </div>
              <div>
                <span className="data-item-title">حد ادنى ري عادي شركات:</span>
                <span className="data-item-value">{cropData.min_tr_comp_val}</span>
              </div>
              <div>
                <span className="data-item-title">حد اقصى ري عادي شركات:</span>
                <span className="data-item-value">{cropData.max_tr_comp_val}</span>
              </div>
              <div>
                <span className="data-item-title">حد ادنى ري حديث  شركات:</span>
                <span className="data-item-value">{cropData.min_mod_comp_val}</span>
              </div>
              <div>
                <span className="data-item-title">حد اقصى ري حديث  شركات:</span>
                <span className="data-item-value">{cropData.max_mod_comp_val}</span>
              </div>
              {cropData.begin && (
