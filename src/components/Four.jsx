      ...
      <form onSubmit={(e) => e.target.preventDefault()}>
        <Stack spacing={3} sx={{ width: '100%' }}>
          <Autocomplete
            ...
            sx={{
              width: 250, backgroundColor: "#fff", borderRadius: 1, '& input': { textAlign: 'center' }, boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px',
            ...
            renderInput={(params) => <TextField {...params} label="الفئة والموسم" sx={{ textAlign: 'center' }} />}
          />

          {(season && season !== "" && season != null) && <Autocomplete
            disablePortal
            id="crop-inp"
            options={Object.keys(data[`${season}`])}
            sx={{
              width: 250, backgroundColor: "#fff", borderRadius: 1, '& input': { textAlign: 'center' }, boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px',
              "& .MuiAutocomplete-popupIndicator": {
                color: "tan",
